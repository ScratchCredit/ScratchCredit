[#1]: https://github.com/ScratchCredit/ScratchCredit/issues/1
[@jayz3314]: https://github.com/jayz3314
[`development`]: https://github.com/ScratchCredit/ScratchCredit/tree/development
[`jayz3314/issue1`]: https://github.com/ScratchCredit/ScratchCredit/tree/jayz3314/issue1
# ScratchCredit
> [!IMPORTANT]
> This is the **`jayz3314/issue1`** branch, made specifically for resolving issue [#1]. Both [the issue this branch was created for][#1] and this branch was created by **[@jayz3314]**.
> If you want to make changes for resolving issue [#1], commit these changes on **this branch**, NOT **[`development`]**.
...
* ...that ScratchCredit was supposed to be called ScratchCoin before Youssef realized that the name "coin" wasn't allowed in a Scratch pretend currency's name?
